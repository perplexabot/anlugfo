...
Example 1:
    ...
    Output: 3
    Explanation:
    - Operation 1: num1 = 2, num2 = 3. Since num1 < num2, we subtract num1 from num2 and get
        num1 = 2, num2 = 3 - 2 = 1.
...
sol = Solution()
for num1, num2, exp in cases:
    assert (
        got := sol.countOperations(num1, num2)
    ) == exp, f"Failed case ({num1}, {num2}) - expecting ({exp}), got ({got})."
